...
const SupplierViewOnly = () => {
  ...
  return (
    <div className="flex bg-gray-100 min-h-screen">
      ...
      {isModalOpen && selectedSupplier && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center overflow-y-auto">
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full m-4 p-6 relative max-h-[90vh] overflow-y-auto">
            ...
            {/* Other Documents */}
            {selectedSupplier.otherDocs &&
              selectedSupplier.otherDocs.length > 0 && (
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">
                    Other Documents
                  </h4>
            ...
            {/* Related People */}
            {selectedSupplier.relatedPeople &&
              selectedSupplier.relatedPeople.length > 0 && (
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-900">
                  {formatDate(
                    selectedSupplier.addedOn || selectedSupplier.createdAt,
                  )}
                </p>
              </div>
            </div>
      ...
      {showModeToggle && (
        <ModeToggle
          componentName="Suppliers Management"
