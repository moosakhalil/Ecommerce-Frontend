...
const ScanTrack = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      let response = await axios.get(
        `${API_BASE_URL}/api/tracking/uti/${searchQuery.trim()}`,
      );
  ...
  const addToRecentScans = (item) => {
    ...
    const updated = [
      newScan,
      ...recentScans.filter((s) => s.uti !== item.uti),
    ].slice(0, 20);
      ...
      >
        <div className="tracking-container">
          <div className="tracking-header">
            <h1>
              <strong>302.</strong> 🔍 Scan & Track Product
            </h1>
          </div>
                  ...
                  >
                    ...
                    <div className="form-row">
                      <div className="tracking-card-row">
                        ...
                        <span className="tracking-card-value">
                          {searchResult.currentLocation?.warehouseZone ||
                            "Unknown"}{" "}
                          -
                    ...
                    <div className="form-row">
                      <div className="tracking-card-row">
                        ...
                        <span className="tracking-card-value">
                          {formatDate(searchResult.receivedDate)}
                        </span>
                      </div>
                      <div className="tracking-card-row">
                            ...
                            <div key={index} className="timeline-item">
                              ...
                              <div className="timeline-content">
                                ...
                                <div className="timeline-text">
                                  {movement.fromLocation?.details} →{" "}
                                  {movement.toLocation?.details}
                                </div>
                                <div className="timeline-text">
                                  By: {movement.movedBy}
                                </div>
                    ...
                    >
                      ...
                      <div className="activity-content">
                        ...
                        <p className="activity-meta">
                          Status: {scan.status?.replace(/_/g, " ")} • Location:{" "}
                          {scan.location}
                        </p>
                      </div>
