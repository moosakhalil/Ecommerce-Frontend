...
const TrackingSettings = () => {
  ...
  const handleAddZone = () => {
    if (newZone.trim() && !zones.includes(newZone.trim())) {
      ...
      alert(`Zone "${newZone.trim()}" added. Note: This is saved locally. Backend persistence requires API integration.`);
    }
  };
    ...
    <div className="flex min-h-screen">
        ...
        <div className="tracking-section">
          ...
          <div className="tracking-form">
            ...
            <div style={{ background: "#f9fafb", padding: "20px", borderRadius: "8px", marginBottom: "16px" }}>
              <h3 style={{ marginTop: 0, marginBottom: "16px" }}>Unique Tracking Identifier (UTI)</h3>
              ...
              <div className="form-group">
                <label style={{ display: "flex", alignItems: "center", gap: "12px", cursor: "pointer" }}>
                  <input
                    ...
                    onChange={(e) => setSettings({ ...settings, autoGenerateUTI: e.target.checked })}
                  />
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) => setSettings({ ...settings, utiFormat: e.target.value })}
                >
                  <option value="productId-batchId-unit">ProductID-BatchID-Unit (e.g., P0001-B250122-U0001)</option>
                  <option value="batch-product-unit">BatchID/ProductID/Unit (e.g., B250122/P0001/0001)</option>
                  <option value="sequential">Sequential Only (e.g., TRK-00000001)</option>
                </select>
              </div>
            </div>
            ...
            {/* Quality Control */}
            <div style={{ background: "#f9fafb", padding: "20px", borderRadius: "8px", marginBottom: "16px" }}>
              <h3 style={{ marginTop: 0, marginBottom: "16px" }}>Quality Control</h3>
              ...
              <div className="form-group">
                <label style={{ display: "flex", alignItems: "center", gap: "12px", cursor: "pointer" }}>
                  <input
                    ...
                    onChange={(e) => setSettings({ ...settings, requireQualityCheck: e.target.checked })}
                  />
                  <span>Require quality check before storage assignment</span>
                </label>
              </div>
            </div>
        ...
        <div className="tracking-section">
          ...
          <div className="tracking-cards-grid">
            {zones.map((zone, index) => (
              <div key={index} className="tracking-card">
                ...
                <div className="tracking-card-content" style={{ marginTop: "12px" }}>
          ...
          {zones.length === 0 && (
            <div className="tracking-empty-state">
              ...
              <p className="empty-text">Add warehouse zones to organize your storage.</p>
            </div>
          )}
        </div>
      )}
      ...
      {activeTab === "alerts" && (
        <div className="tracking-section">
          ...
          <div className="tracking-form">
            {/* Expiry Alerts */}
            <div style={{ background: "#fef3c7", padding: "20px", borderRadius: "8px", marginBottom: "16px" }}>
              <div style={{ display: "flex", alignItems: "flex-start", gap: "16px" }}>
                <span style={{ fontSize: "24px" }}>⏰</span>
                <div style={{ flex: 1 }}>
                  <h3 style={{ marginTop: 0, marginBottom: "12px" }}>Expiry Date Alerts</h3>
                  ...
                  {settings.enableExpiryAlerts && (
                    <div className="form-group" style={{ marginBottom: 0 }}>
                      <label className="form-label">Alert threshold (days before expiry)</label>
                      <input
                        type="number"
                        className="form-input"
            ...
            <div style={{ background: "#fee2e2", padding: "20px", borderRadius: "8px" }}>
              <div style={{ display: "flex", alignItems: "flex-start", gap: "16px" }}>
                <span style={{ fontSize: "24px" }}>📦</span>
                <div style={{ flex: 1 }}>
                  <h3 style={{ marginTop: 0, marginBottom: "12px" }}>Low Stock Alerts</h3>
