      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <span className={`px-4 py-2 rounded-full text-sm font-medium ${getStatusBadge(vehicle.status)}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              ...
              {vehicle.chassisNumber && (
                <div className="flex justify-between py-2 border-b">
                  ...
                  <span className="text-gray-900 text-sm">{vehicle.chassisNumber}</span>
                </div>
              )}
            </div>
          </div>
              ...
              {vehicle.vehicleType === 'truck' && vehicle.dimensions && (
                <>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="text-gray-900">{vehicle.dimensions.heightCm} cm</span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    <span className="text-gray-600 font-medium">Width:</span>
                    <span className="text-gray-900">{vehicle.dimensions.widthCm} cm</span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-3">
              {vehicle.yearModel && (
                <div className="flex justify-between py-2 border-b">
                  <span className="text-gray-600 font-medium">Year Model:</span>
              ...
              {vehicle.engineSizeCc && (
                <div className="flex justify-between py-2 border-b">
                  ...
                  <span className="text-gray-900">{vehicle.engineSizeCc} cc</span>
                </div>
              )}
              {vehicle.odometerKm && (
                <div className="flex justify-between py-2 border-b">
                  <span className="text-gray-600 font-medium">Odometer:</span>
                  <span className="text-gray-900">{vehicle.odometerKm.toLocaleString()} km</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between py-2 border-b">
                <span className="text-gray-600 font-medium">Service Due:</span>
                <span className={`text-gray-900 ${
                  vehicle.serviceDueDate && new Date(vehicle.serviceDueDate) < new Date() 
              ...
              <div className="flex justify-between py-2 border-b">
                <span className="text-gray-600 font-medium">Insurance Expiry:</span>
                <span className={`text-gray-900 ${
            ...
            {((vehicle.serviceDueDate && new Date(vehicle.serviceDueDate) < new Date()) ||
              ...
              <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-lg flex items-center gap-2 text-red-700">
                <AlertCircle size={20} />
                <span className="text-sm font-medium">Action Required: Service or insurance overdue</span>
              </div>
            )}
          </div>
        </div>
        ...
        {/* Document Images */}
        {vehicle.images && Object.values(vehicle.images).some(img => img) && (
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mt-6">
          <div className="flex justify-between text-sm text-gray-600">
            <div>
              <span className="font-medium">Created:</span> {formatDate(vehicle.createdAt)}
            </div>
            <div>
              <span className="font-medium">Last Updated:</span> {formatDate(vehicle.updatedAt)}
            </div>
          </div>
        </div>
      </div>
