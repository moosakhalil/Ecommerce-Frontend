      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-6">
            <strong>111.</strong> Add New Vehicle
          </h1>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <button
                  type="button"
                  onClick={() =>
                    setFormData({ ...formData, vehicleType: "scooter" })
                  }
                  className={`p-4 border-2 rounded-lg flex flex-col items-center gap-2 transition-all ${
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder={
                      formData.vehicleType === "truck" ? "5000" : "80"
                    }
                  />
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-blue-400 transition-colors">
                    ...
                    />
                    <label
                      htmlFor="stnkIconPhoto"
                      className="cursor-pointer flex flex-col items-center gap-2"
                    >
                      {imagePreviews.stnkIconPhoto ? (
                        <img
                          src={imagePreviews.stnkIconPhoto}
                          alt="STNK Icon Preview"
                          className="w-full h-32 object-cover rounded"
                        />
                      ) : (
                        <Upload className="text-gray-400" />
                      ...
                      <span className="text-sm text-gray-600">
                        {images.stnkIconPhoto
                          ? images.stnkIconPhoto.name
                          : "Upload STNK icon"}
                      </span>
                    </label>
                  </div>
