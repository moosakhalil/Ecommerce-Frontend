...
const AddVehicleStep1 = () => {
    ...
    const fetchTemplates = async () => {
      try {
        const response = await axios.get(
          `${API_BASE_URL}/api/vehicle-templates`,
        );
  ...
  const handleSave = async () => {
    ...
    if (vehicleType === "truck") {
      if (
        !formData.truckTypeName ||
        !formData.weightMaxKg ||
        !formData.heightCm ||
        !formData.widthCm ||
        !formData.lengthCm ||
        !formData.maxPackageLength
      ) {
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          ⚠️ Temporary name. You'll add the actual number plate
                          in the next step.
                        </p>
                      </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-1">
                        ⚠️ Temporary name. You'll add the actual number plate in
                        the next step.
                      </p>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
                    ...
                    <p className="text-blue-800 text-sm leading-relaxed">
                      This page allows you to register a new vehicle into the
                      system. You will need to provide vehicle details like
                      plate number, model, type, and capacity. This is the first
