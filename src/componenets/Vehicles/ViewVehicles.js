  ...
  const handleDelete = async () => {
    try {
      const response = await axios.delete(
        `${API_BASE_URL}/api/vehicles/${vehicleToDelete._id}`,
      );
      if (response.data.success) {
        fetchVehicles();
            ...
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-3">
                <h1 className="text-2xl font-bold text-gray-800">
                  <strong>112.</strong> Vehicle Management
                </h1>
                <button
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusBadge(vehicle.status)}`}
                      >
                        {vehicle.status}
                      </span>
                    </div>
                        ...
                        vehicle.dimensions && (
                          <>
                            <div className="flex justify-between text-sm">
                              ...
                              <span className="font-medium">
                                {vehicle.dimensions.heightCm}×
                                {vehicle.dimensions.widthCm}×
                            ...
                            {vehicle.totalDimensionsCubicCm && (
                              <div className="flex flex-col text-sm">
                                ...
                                <div className="flex justify-end text-base font-bold text-blue-700 mt-1">
                                  (
                                  {(
                                    vehicle.totalDimensionsCubicCm / 1000000
                                  ).toFixed(2)}{" "}
                                  m³)
                                </div>
                              </div>
                          ...
                          <>
                            ...
                            <div className="flex justify-between text-sm bg-purple-50 -mx-4 px-4 py-1">
                              ...
                              <span className="font-bold text-purple-600">
                                {Math.round(
                                  (vehicle.maxPackages *
                                    (vehicle.packageLimitPercent || 80)) /
                                    100,
                                )}
                              </span>
                            </div>
                    ...
                    <div className="flex gap-2 pt-4 border-t">
                      <button
                        onClick={() =>
                          navigate(`/admin/vehicles/view/${vehicle._id}`)
                        }
                ...
                <div className="space-y-4">
                  <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
                    ...
                    <p className="text-blue-800 text-sm leading-relaxed">
                      This page displays a list of all registered vehicles. You
                      can view vehicle details, edit information, check status,
                      and manage the fleet from this dashboard.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="text-sm text-gray-600 space-y-2 pl-4 list-disc">
                      <li>
                        Filter vehicles by type (Truck/Scooter) and status
                      </li>
