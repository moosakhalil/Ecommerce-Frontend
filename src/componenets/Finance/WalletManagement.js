...
const WalletManagement = () => {
  ...
  const handleAddCredit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/wallets/${selectedWallet._id}/credit`,
        {
          method: "POST",
  ...
  const handleDeductBalance = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/wallets/${selectedWallet._id}/debit`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  return (
    <div className="flex h-screen bg-gray-100">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h1 className="text-2xl font-bold text-gray-800">
                  <strong>259.</strong> 💳 Wallet Management
                </h1>
                <p className="text-gray-600">
                  Manage customer wallet balances and transactions
                </p>
              </div>
                        ...
                        wallets.map((wallet) => (
                          <tr key={wallet._id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-right">
                              <span
                                className={`font-semibold ${wallet.balance > 0 ? "text-green-600" : "text-gray-500"}`}
                              >
                        ...
                        <tr>
                          ...
                          >
                            {searchTerm
                              ...
                              : "No wallets available. Click 'Create Wallet' to add one."}
                          </td>
                        </tr>
                      )}
                    </tbody>
              ...
              <div className="flex gap-3 mb-6">
                <button
                  onClick={() => {
                    ...
                    openCreditModal(selectedWallet);
                  }}
                    ...
                    <p className="text-sm text-green-600">
                      ...
                      {formatCurrency(
                        selectedWallet.balance +
                          parseInt(transactionForm.amount || 0),
                      )}
                    </p>
                  </div>
                )}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setCreateForm((prev) => ({
                        ...prev,
                        initialBalance: parseInt(value) || 0,
                      }));
                    }}
                    placeholder="0"
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
      ...
      {showModeToggle && (
        <ModeToggle
          componentName="Wallet Management"
