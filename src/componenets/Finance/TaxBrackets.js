...
const TaxBrackets = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        setSuccess(
          data.message ||
            `Tax bracket ${editingBracket ? "updated" : "created"} successfully`,
        );
        fetchTaxBrackets();
        closeModal();
      } else {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/tax-brackets/${deletingBracket._id}`,
        {
          method: "DELETE",
        },
      );
  ...
  const handleToggleStatus = async (bracket) => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/tax-brackets/${bracket._id}/toggle-status`,
        {
          method: "PATCH",
        },
      );
  ...
  const filteredBrackets = taxBrackets.filter(
    (bracket) =>
  ...
  return (
    <div className="flex h-screen bg-gray-100">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h1 className="text-2xl font-bold text-gray-800">
                  <strong>258.</strong> 💰 Tax Brackets
                </h1>
              ...
              <div className="bg-white shadow-md rounded-lg overflow-hidden">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {filteredBrackets.length > 0 ? (
                        ...
                        <tr>
                          ...
                          >
                            {searchTerm
                              ? "No tax brackets found matching your search"
                              : "No tax brackets available. Click '+ Add New' to create one."}
                          </td>
                        </tr>
                      )}
                    </tbody>
                ...
                <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
                  ...
                  <span className="text-sm text-gray-400 ml-4">
                    Note: "Unknown Tax Bracket" is a system default and cannot
                    be edited/deleted.
                  </span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-sm mx-4">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                Are you sure you want to delete "{deletingBracket?.bracketName}
      ...
      {showModeToggle && (
        <ModeToggle
          componentName="Tax Brackets Management"
