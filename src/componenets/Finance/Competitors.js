...
const Competitors = () => {
  ...
  const fetchLargerStates = async (islandId) => {
    try {
      const res = await axios.get(
        `${API_BASE}/area-management/larger-states?islandId=${islandId}`,
      );
  ...
  const fetchRegencies = async (largerStateId) => {
    try {
      const res = await axios.get(
        `${API_BASE}/area-management/regencies?largerStateId=${largerStateId}`,
      );
  ...
  const fetchGeoAreas = async (regencyId) => {
    try {
      const res = await axios.get(
        `${API_BASE}/area-management/areas?regencyId=${regencyId}`,
      );
      setAreas(res.data);
    } catch (error) {
  ...
  const generateNewId = async () => {
    try {
      ...
      setFormData((prev) => ({
        ...prev,
        competitorId: response.data.competitorId,
      }));
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      !photos.photoShopFar ||
      !photos.photoShopClose ||
      !photos.photoStreetLeft ||
      !photos.photoStreetRight
    ) {
  ...
  const handleSelectCompetitor = async (competitorId) => {
    try {
      ...
      const response = await axios.get(
        `${API_BASE}/competitors/${competitorId}`,
      );
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
                  ...
                  {competitors
                    .filter((c) => {
                      ...
                      return (
                        ...
                        (c.competitorId &&
                          c.competitorId.toLowerCase().includes(search)) ||
                        (c.phoneNumber &&
                          c.phoneNumber.toLowerCase().includes(search)) ||
                        (c.googleMapsLocation &&
                          c.googleMapsLocation
                            .toLowerCase()
                            .includes(search)) ||
                        ...
                        (c.shopSize &&
                          c.shopSize.toLowerCase().includes(search))
                      );
                    })
                    .map((c) => (
                ...
                <div className="mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <p className="text-gray-600">
                          <strong>Phone:</strong>{" "}
                          {selectedCompetitor.phoneNumber || "N/A"}
                        </p>
                        <p className="text-gray-600">
                          <strong>Shop Size:</strong>{" "}
                          {selectedCompetitor.shopSize}
                        </p>
                        <p className="text-gray-600">
                          <strong>Google Maps:</strong>{" "}
                          {selectedCompetitor.googleMapsLocation || "N/A"}
                        </p>
                      </div>
                      <div>
                        <p className="text-gray-600">
                          <strong>Geo 1:</strong>{" "}
                          {selectedCompetitor.geo1 || "Not set"}
                        </p>
                        <p className="text-gray-600">
                          <strong>Geo 2:</strong>{" "}
                          {selectedCompetitor.geo2 || "Not set"}
                        </p>
                        <p className="text-gray-600">
                          <strong>Geo 3:</strong>{" "}
                          {selectedCompetitor.geo3 || "Not set"}
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="flex flex-wrap gap-4">
                        {selectedCompetitor.photoLocation && (
                          <div className="text-center">
                            <img
                              src={`${API_BASE_URL}${selectedCompetitor.photoLocation}`}
                              alt="Location"
                        ...
                        {selectedCompetitor.photoShopFar && (
                          <div className="text-center">
                            <img
                              src={`${API_BASE_URL}${selectedCompetitor.photoShopFar}`}
                              alt="Shop Far"
                              className="w-24 h-24 object-cover rounded-lg border"
                            />
                            <p className="text-xs text-gray-500 mt-1">
                        ...
                        {selectedCompetitor.photoShopClose && (
                          <div className="text-center">
                            <img
                              src={`${API_BASE_URL}${selectedCompetitor.photoShopClose}`}
                              alt="Shop Close"
                              className="w-24 h-24 object-cover rounded-lg border"
                            />
                            <p className="text-xs text-gray-500 mt-1">
                        ...
                        {selectedCompetitor.photoStreetLeft && (
                          <div className="text-center">
                            <img
                              src={`${API_BASE_URL}${selectedCompetitor.photoStreetLeft}`}
                              alt="Street Left"
                              className="w-24 h-24 object-cover rounded-lg border"
                            />
                            <p className="text-xs text-gray-500 mt-1">
                        ...
                        {selectedCompetitor.photoStreetRight && (
                          <div className="text-center">
                            <img
                              src={`${API_BASE_URL}${selectedCompetitor.photoStreetRight}`}
                              alt="Street Right"
                              className="w-24 h-24 object-cover rounded-lg border"
                            />
                            <p className="text-xs text-gray-500 mt-1">
                  ...
                  <div className="bg-blue-50 rounded-lg p-6 mb-6">
                    <h4 className="font-bold text-gray-800 mb-4">
                      Add Product This Competitor Sells
                    </h4>
                  ...
                  <div className="bg-white border rounded-lg">
                    <div className="p-4 border-b flex justify-between items-center">
                      <h4 className="font-bold text-gray-800">
                        Products Sold by This Competitor
                      </h4>
                      <span className="text-xs text-gray-500 italic">
                        * Products can only be deleted within 24 hours of adding
                      </span>
                    </div>

                    {selectedCompetitor.products &&
      ...
      {showModeToggle && (
        <ModeToggle
          componentName="Competitors Management"
