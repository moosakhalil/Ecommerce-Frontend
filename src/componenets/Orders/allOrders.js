...
export default function AllOrders() {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      console.log("URL:", `${API_BASE_URL}/api/orders?${params}`);
  ...
  return (
    <div className="flex min-h-screen">
      ...
      >
        <div className="bg-purple-900 text-white p-4 flex items-center relative">
        ...
        {showModeToggle && (
          <ModeToggle
            componentName="All Orders - Complete Order Management"
