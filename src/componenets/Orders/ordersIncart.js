...
export default function OrdersInCart() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      >
        {/* Header */}
        <header className="bg-gray-700 text-white p-4 relative">
          ...
          <div className="absolute top-4 right-4 flex gap-3">
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-lg hover:shadow-lg transition-all flex items-center gap-2 font-semibold"
            >
            ...
            <button
              onClick={() => setShowModeToggle(true)}
              className="px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg hover:shadow-lg transition-all flex items-center gap-2 font-semibold"
            >
              <span className="text-xl">🤖</span>
              <span>AI</span>
            </button>
        ...
        {showModeToggle && (
          <ModeToggle
            componentName="Orders in Cart - Not Ordered Yet"
