...
const ViewProducts = () => {
  ...
  const handleExcelUpload = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${API_URL}/api/products/upload-excel`,
        formData,
        {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      >
        ...
        <div className="bg-purple-900 text-white p-3 flex justify-between items-center mb-4">
          <h1 className="text-xl font-medium">
            <strong>106.</strong> Product List
          </h1>
          <div className="flex items-center space-x-2">
            {/* Advanced and AI Mode Buttons */}
            <button
              onClick={() => setShowModeToggle(true)}
              className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 px-4 py-2 rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl flex items-center space-x-2"
            >
              <span>🚀</span>
              <span>Advanced</span>
            </button>
            <button
              onClick={() => setShowModeToggle(true)}
              className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 px-4 py-2 rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl flex items-center space-x-2"
            >
              <span>🤖</span>
              <span>AI</span>
            </button>
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-sm text-green-700">
                  Created: {uploadResult.summary.created} | Skipped:{" "}
                  {uploadResult.summary.skipped} | Total:{" "}
                  ...
                  <div className="mt-2">
                    ...
                    <ul className="text-xs text-red-500 max-h-20 overflow-y-auto">
                      ...
                      {uploadResult.summary.errors.length > 5 && (
                        <li>
                          ...and {uploadResult.summary.errors.length - 5} more
                          errors
                        </li>
                      )}
                    </ul>
                    ...
                    {loading ? (
                      ...
                      products.map((product) => (
                        <tr key={product._id} className="hover:bg-gray-50">
                          ...
                          {/* BID - Batch ID: Shows batch numbers if product has batch discounts */}
                          <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
      ...
      {showModeToggle && (
        <ModeToggle
          componentName="Product List Management"
