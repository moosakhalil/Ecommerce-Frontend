...
const AddProduct = () => {
  ...
  // ✅ NEW: Additional Display Categories state
  const [additionalDisplayCategories, setAdditionalDisplayCategories] =
    useState([]);
  const [showDisplayCategoryInfo, setShowDisplayCategoryInfo] = useState(false);
  ...
  const discountCategories = [
    {
      ...
      eligibility: {
        ...
        notes:
          "Foremen are typically construction workers or contractors who buy in bulk",
      },
    },
    {
      ...
      eligibility: {
        ...
        duration:
          "24/7 - Always available as long as commission rights are active",
        notes:
          "This is a premium tier above regular Foremen with additional discounts",
      },
    },
    {
      id: "referral_3_days",
      ...
      eligibility: {
        ...
        whoGetsIt:
          "Customers who have successfully referred 3 or more new customers",
        howToQualify: [
        ...
        calculation:
          "Example: 3 referrals = 3 days, 5 referrals = 5 days, 10 referrals = 10 days",
    ...
    },
    {
      ...
      eligibility: {
        ...
        notes:
          "This discount incentivizes new referred customers to shop quickly",
      },
    },
    {
      id: "new_customer",
      ...
      eligibility: {
        ...
        notes:
          "Welcome discount to encourage first-time buyers to make a purchase",
      },
    },
    {
      id: "shopping_30m",
      ...
      eligibility: {
        ...
        whoGetsIt:
          "Customers who made a single purchase of Rp 30,000,000 or more",
        howToQualify: [
          "Make a single order totaling at least Rp 30,000,000",
          "Must be in one transaction (not cumulative)",
        ],
        duration:
          "10 days from the qualifying purchase, or until next 30M+ purchase (whichever is later)",
    ...
    },
    {
      ...
      eligibility: {
        ...
        duration:
          "10 days from reaching the threshold, or until next 100M threshold",
    ...
    },
    {
      ...
      eligibility: {
        ...
        notes:
          "General promotions and sales available to the entire customer base",
      },
    },
  ];
  ...
  useEffect(() => {
    ...
    const randomNum = String(Math.floor(Math.random() * 9999) + 1).padStart(
      4,
      "0",
    );
  ...
  // Toggle additional display category/subcategory
  const toggleAdditionalDisplayCategory = (
    categoryName,
    ...
    const key = subcategoryName
      ...
      : categoryName;
    setAdditionalDisplayCategories((prev) => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        console.log("📂 Categories fetched from database:", res.data.data);
  ...
  const getBestSupplierByDelivery = () => {
    const suppliersWithDelivery = suppliers.filter(
      (s) =>
        s.manualAverageDeliveryTime &&
        !isNaN(parseInt(s.manualAverageDeliveryTime)),
    );
  ...
  const fetchParentProductDetails = async (productId) => {
    try {
      const response = await axios.get(
        `${API_URL}/api/products/by-product-id/${productId}`,
      );
      if (response.data && response.data.success) {
  ...
  const validateForm = () => {
    ...
    if (missingFields.length > 0) {
      ...
      toast.error(
        `Please fill in required fields: ${readableFields.join(", ")}`,
      );
      return false;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (
        ...
        console.log(
          "🏷️ Batch discounts added to payload:",
          payload.batchDiscounts,
        );
      }

      // ✅ Add additional display categories
      if (additionalDisplayCategories.length > 0) {
        // Parse and structure the additional display categories
        const parsedDisplayCategories = additionalDisplayCategories.map(
          (item) => {
            if (item.includes("|")) {
              const [category, subcategory] = item.split("|");
              return { category, subcategory, type: "category_subcategory" };
            } else {
              return {
                category: item,
                subcategory: null,
        ...
        payload.additionalDisplayCategories = additionalDisplayCategories;
        payload.additionalDisplayCategoriesParsed = parsedDisplayCategories;

        console.log(
          "📍 Additional display categories (raw):",
          payload.additionalDisplayCategories,
        );
        console.log(
          "📍 Additional display categories (parsed):",
          payload.additionalDisplayCategoriesParsed,
        );
      }
      ...
      console.log("📦 Preparing payload with formData:", {
        ...
        additionalDisplayCategories: payload.additionalDisplayCategories,
      });
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
            ...
            {productType && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                      ...
                      <>
                          ...
                          <div className="border border-gray-300 rounded-lg">
                            ...
                            <div className="grid grid-cols-5 gap-2 p-2 border-t border-gray-300 text-xs">
                              <input
                                ...
                                onChange={(e) =>
                                  handleSpecChange(0, "height", e.target.value)
                                }
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  handleSpecChange(0, "length", e.target.value)
                                }
                                className="border border-gray-300 p-1 rounded"
                                required
                              />
                              <input
                                ...
                                onChange={(e) =>
                                  handleSpecChange(0, "width", e.target.value)
                                }
                                className="border border-gray-300 p-1 rounded"
                                required
                              />
                              <input
                                ...
                                onChange={(e) =>
                                  handleSpecChange(0, "weight", e.target.value)
                                }
                                className="border border-gray-300 p-1 rounded"
                                required
                              />
                              <input
                                ...
                                value={
                                  formData.specifications[0]?.colours || ""
                                }
                                onChange={(e) =>
                                  handleSpecChange(0, "colours", e.target.value)
                                }
                                className="border border-gray-300 p-1 rounded"
                              />
                            </div>
                        ...
                        <div className="mb-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                          ...
                          <p className="text-xs text-gray-600 mb-3">
                            By default, products are large (truck delivery).
                            Click below to mark as small package (scooter
                            delivery).
                          </p>
                          ...
                          {formData.packageSize === "Large" && (
                            <div className="mt-2 text-xs text-gray-500 flex items-center">
                              ...
                              <span>
                                Currently set as Large Package (Truck Delivery)
                              </span>
                            </div>
                          )}
                        </div>
                            ...
                            <div className="flex items-start mb-3">
                              <input
                                ...
                                onChange={() =>
                                  setFormData({
                                    ...formData,
                                    lowInventoryCalculation:
                                      !formData.lowInventoryCalculation,
                                  })
                                }
                                className="mr-2 mt-1"
                              />
                              <label className="text-xs text-gray-700">
                                This product can't show correct statistics or
                                reorder mechanism for sales as it has too low
                            ...
                            {(() => {
                              ...
                              return bestSupplier ? (
                                <p className="text-xs text-gray-700">
                                  Best supplier according to delivery days (from
                                  all suppliers):{" "}
                                  <span className="font-semibold">
                                    {bestSupplier.name}
                                  </span>{" "}
                                  <span className="text-green-600">
                                    ({bestSupplier.manualAverageDeliveryTime}{" "}
                                    days)
                                  </span>
                                </p>
                              ) : (
                          ...
                          <div className="text-xs text-gray-700">
                            <p className="mb-2">
                              <span className="font-medium">
                                Minimum stock to be held
                              </span>{" "}
                              = Safety Stock + Delivery Time (in days)
                            </p>

                            {(() => {
                              const safetyStock =
                                parseInt(formData.safetyDaysStock) || 0;
                ...
                <div className="bg-white p-4 rounded shadow">
                  ...
                  {productType === "Child" && parentProductDetails && (
                    <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                      ...
                      <div className="mb-3 p-3 bg-white rounded border border-blue-100">
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            ...
                            <div className="font-medium text-gray-800">
                              {parentProductDetails.categories || "N/A"}
                            </div>
                          </div>
                          <div>
                            <div className="text-xs text-gray-500 mb-1">
                            ...
                            <div className="font-medium text-gray-800">
                              {parentProductDetails.subCategories || "N/A"}
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      {additionalCategories.length > 0 && (
                        <div className="mb-3">
                          ...
                          {additionalCategories.map((addCat, index) => (
                            <div
                              key={index}
                              className="mb-2 p-3 bg-white rounded border border-gray-200"
                            >
                              <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="mt-2 p-2 bg-blue-100 border border-blue-300 rounded text-xs text-blue-800">
                        ℹ️ Additional categories will be saved automatically
                        when you submit the form
                      </div>
                    </div>
                  )}

                  {/* Primary Categories & Subcategories - Hidden for Child products, shown for Normal/Parent */}
                  {productType !== "Child" && (
                    <div className="mb-6 p-5 bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-50 border-3 border-blue-400 rounded-xl shadow-md">
                      <div className="mb-4 pb-3 border-b-2 border-blue-300">
                        <h3 className="text-base font-bold text-blue-900 flex items-center">
                          🏪 Shop categories where the product belongs to in
                          shop and app
                        </h3>
                        <p className="text-xs text-blue-700 mt-1 italic">
                          This defines the primary location where customers will
                          find this product and where it belongs to in shop and
                          app
                        </p>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={handleChange}
                            className="w-full border-2 border-blue-300 p-3 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 bg-white font-medium"
                            required
                          >
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={handleChange}
                            className="w-full border-2 border-blue-300 p-3 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 bg-white font-medium disabled:bg-gray-100 disabled:cursor-not-allowed"
                  ...
                  {/* Additional Display Categories Section */}
                  <div className="mb-6 p-4 bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-200 rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="text-base font-bold text-purple-900 flex items-center">
                        📍 Display Product in Additional Categories
                      </h3>
                      <button
                        type="button"
                        onClick={() => setShowDisplayCategoryInfo(true)}
                        className="bg-blue-500 hover:bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold transition-colors"
                    ...
                    <p className="text-xs text-gray-700 mb-4 italic">
                      ⚠️ This is for extra display locations only. It does not
                      change the product's primary category.
                    </p>

                    <div className="bg-white p-4 rounded-lg border border-purple-200 max-h-96 overflow-y-auto">
                      <p className="text-sm font-medium text-gray-700 mb-3">
                        Select additional categories/subcategories where this
                        product should also appear:
                      </p>
                      ...
                      {categoriesList.length === 0 ? (
                        ...
                        categoriesList.map((category) => (
                          <div
                            key={category._id}
                            className="mb-4 border-b border-gray-200 pb-3 last:border-b-0"
                          >
                            {/* Category Checkbox */}
                            <div className="flex items-start mb-2">
                              <input
                                type="checkbox"
                                id={`display-cat-${category._id}`}
                                checked={additionalDisplayCategories.includes(
                                  category.name,
                                )}
                                onChange={() =>
                                  toggleAdditionalDisplayCategory(category.name)
                                }
                                disabled={
                              ...
                              />
                              <label
                                htmlFor={`display-cat-${category._id}`}
                                className={`text-sm font-semibold ${
                                  formData.categories === category.name &&
                                  !formData.subCategories
                                    ? "text-gray-400 line-through"
                                    : "text-gray-800 cursor-pointer hover:text-purple-600"
                                }`}
                              >
                                {category.name}
                                {formData.categories === category.name &&
                                  ...
                                  {category.subcategories.map((subcategory) => {
                                    ...
                                    return (
                                      ...
                                      >
                                        <input
                                          type="checkbox"
                                          id={`display-sub-${category._id}-${subcategory}`}
                                          checked={additionalDisplayCategories.includes(
                                            key,
                                          )}
                                          onChange={() =>
                                            toggleAdditionalDisplayCategory(
                                              category.name,
                                              subcategory,
                                            )
                                          }
                                          disabled={isPrimarySubcategory}
                                          className="mr-2 h-3 w-3"
                                        />
                                        <label
                                          htmlFor={`display-sub-${category._id}-${subcategory}`}
                                          className={`text-xs ${
                                            isPrimarySubcategory
                                              ? "text-gray-400 line-through"
                    ...
                    {additionalDisplayCategories.length > 0 && (
                      <div className="mt-4 p-3 bg-purple-100 rounded-lg border border-purple-300">
                        <div className="flex items-center justify-between mb-2">
                          <p className="text-xs font-semibold text-purple-900">
                            📋 Product will also appear in (
                            {additionalDisplayCategories.length} location
                            {additionalDisplayCategories.length !== 1
                              ? "s"
                              : ""}
                            ):
                          </p>
                          <button
                            type="button"
                            onClick={() => setAdditionalDisplayCategories([])}
                        ...
                        <div className="flex flex-wrap gap-2">
                          {additionalDisplayCategories.map((item) => (
                            <span
                              key={item}
                              className="inline-flex items-center bg-white px-3 py-1 rounded-full text-xs font-medium text-purple-700 border border-purple-300"
                            >
                              {item.includes("|")
                                ? item.replace("|", " → ")
                                : item}
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  toggleAdditionalDisplayCategory(cat, sub);
                                }}
                  ...
                  <div className="mb-6 p-4 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 rounded-lg">
                    <div className="mb-3">
                      ...
                      <p className="text-xs text-green-700 mt-1 italic">
                        <strong>
                          Dynamic tax rates from Tax Bracket Management
                          (Component 258)
                        </strong>{" "}
                        - Not hardcoded
                      </p>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        const selectedBracket = taxBrackets.find(
                      ...
                      className="w-full border-2 border-green-300 p-2 rounded-lg focus:border-green-500 focus:ring-2 focus:ring-green-200 bg-white"
                    >
                    ...
                    {formData.taxBracketId && (
                      <p className="text-xs text-gray-500 mt-2 p-2 bg-green-100 rounded border border-green-200">
                        ✅ Applied Tax Rate:{" "}
                        <strong>{formData.taxPercentage}%</strong> (
                        {formData.taxBracketCode})
                      </p>
                    )}
                  </div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleBatchDiscountPriceChange(e.target.value)
                              }
                        ...
                        <div className="text-xs text-gray-500 bg-white p-2 rounded border">
                          ...
                          {formData.NormalPrice
                            ? parseFloat(formData.NormalPrice).toLocaleString()
                            : "0"}
                        ...
                        <div className="text-xs text-blue-600 bg-blue-50 p-2 rounded flex items-start">
                          ...
                          <span>
                            Enter the discount price manually. The discount
                            percentage will be calculated automatically based on
                            the original price.
                          </span>
                        </div>
                      </div>
          ...
          >
            ...
            <div className={`${discountInfoModal.bgColor} p-6 text-white`}>
              ...
              <p className="text-sm opacity-90 mt-2">
                {discountInfoModal.eligibility.title}
              </p>
            </div>
            ...
            <div className="p-6 space-y-5 max-h-[60vh] overflow-y-auto">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {discountInfoModal.eligibility.howToQualify.map(
                    (item, idx) => (
      ...
      {/* Additional Display Categories Info Modal */}
      {showDisplayCategoryInfo && (
        <div
          className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
          onClick={() => setShowDisplayCategoryInfo(false)}
        >
          <div
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-90 mt-1">
                      Extra visibility for your product
                    </p>
                  </div>
                </div>
                <button
            ...
            <div className="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
              ...
              <div className="bg-purple-50 rounded-lg p-5 border-l-4 border-purple-500">
                <h3 className="text-lg font-bold text-purple-900 mb-3 flex items-center">
                  <span className="mr-2">🎯</span> Core Purpose
                </h3>
                <p className="text-gray-800 leading-relaxed">
                  This feature allows your product to be{" "}
                  <strong>displayed</strong> in other categories and
                  subcategories beyond its primary placement. Think of it as
                  giving your product extra visibility across multiple sections
                  of your store.
                </p>
              </div>
                  ...
                  <div className="flex items-start bg-gray-50 rounded-lg p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Your product's main category/subcategory remains
                        unchanged. This is where it truly belongs.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start bg-gray-50 rounded-lg p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Select other categories/subcategories where you want
                        this product to ALSO appear for customers.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start bg-gray-50 rounded-lg p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        The same product will now show up in multiple sections,
              ...
              <div className="bg-yellow-50 rounded-lg p-5 border-l-4 border-yellow-500">
                ...
                <p className="text-gray-800 leading-relaxed mb-3">
                  <strong>
                    This feature does NOT change or override your product's
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2 mt-1">✓</span>
                    <span>
                      Your product's primary category and subcategory remain the
                      same
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2 mt-1">✓</span>
                    <span>
                      This only affects where the product is SHOWN to customers
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2 mt-1">✓</span>
                    <span>
                      Reports and inventory tracking still use the primary
                      category
                    </span>
                  </li>
                </ul>
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-800 mb-3 flex items-center">
                  <span className="mr-2">💡</span> Example Use Case
                </h3>
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  <p className="text-sm text-gray-700 mb-2">
                    <strong>Product:</strong>{" "}
                    <span className="text-blue-700">
                      Heavy-Duty Construction Hammer
                    </span>
                  </p>
                  <p className="text-sm text-gray-700 mb-2">
                    <strong>Primary Category:</strong>{" "}
                    <span className="text-blue-700">Tools → Hand Tools</span>
                  </p>
                  <p className="text-sm text-gray-700 mb-3">
                    <strong>Additional Display In:</strong>
                  </p>
                  <ul className="space-y-1 text-sm text-gray-600 ml-4">
                    <li>• Construction Equipment → Basic Tools</li>
                    <li>• Home Improvement → DIY Essentials</li>
                    <li>• Hardware → Carpentry Supplies</li>
                  </ul>
                  <p className="text-xs text-gray-500 mt-3 italic">
                    Now customers can find this hammer in 4 different places,
              ...
              <div className="bg-green-50 rounded-lg p-5 border-l-4 border-green-500">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start text-gray-700">
                    <span className="text-green-500 mr-2 mt-1">★</span>
                    <span>
                      <strong>Increased Visibility:</strong> Product appears in
                      more places
                    </span>
                  </li>
                  <li className="flex items-start text-gray-700">
                    <span className="text-green-500 mr-2 mt-1">★</span>
                    <span>
                      <strong>Better Discoverability:</strong> Customers
                      browsing different categories can still find your product
                    </span>
                  </li>
                  <li className="flex items-start text-gray-700">
                    <span className="text-green-500 mr-2 mt-1">★</span>
                    <span>
                      <strong>Cross-Category Sales:</strong> Capture customers
                      who might not think to look in the primary category
                    </span>
                  </li>
                  <li className="flex items-start text-gray-700">
                    <span className="text-green-500 mr-2 mt-1">★</span>
                    <span>
                      <strong>Flexible Marketing:</strong> Promote products
                      across multiple relevant sections
                    </span>
                  </li>
                </ul>
              </div>
      ...
      {showModeToggle && (
        <ModeToggle
          componentName="Create New Product"
