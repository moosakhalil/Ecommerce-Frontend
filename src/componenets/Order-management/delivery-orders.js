...
export default function OrderManagementDelivery() {
  ...
  const fetchDrivers = async () => {
    try {
      ...
      // The API returns employees array directly
  ...
  const handleDoneTimeSlot = async () => {
    if (!selectedTimeSlot || !selectedDriver) {
      alert("Please select all required fields (time slot and driver)");
      return;
    }
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        <header className="bg-gradient-to-r from-gray-800 to-gray-900 text-white p-6 rounded-lg shadow-md mb-6 relative">
        ...
        {showModeToggle && (
          <ModeToggle
            componentName="Order Management Delivery - Driver Assignment"
        ...
        <main className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-gray-800 mb-6 flex items-center gap-4">
              ...
              <strong>4.</strong> Delivery Orders
            </h1>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div className="bg-white p-4 rounded-lg shadow-sm border">
              ...
              >
                ...
                {areas.map((area) => (
                  <option key={area._id} value={area.displayName}>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border">
              <label className="block text-sm font-medium mb-2 text-gray-700">
                Pick driver{" "}
                {drivers.length > 0 && `(${drivers.length} available)`}
              </label>
              <select
                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white"
