...
const DiscountPageInfo = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const categoriesRes = await axios.get(
        `${API_URL}/api/batch-discounts/categories/info`,
      );
      ...
      const analyticsRes = await axios.get(
        `${API_URL}/api/batch-discounts/analytics/summary`,
      );
      ...
      const customersRes = await axios.get(
        `${API_URL}/api/batch-discounts/categories/eligible-customers`,
      );
                                        ...
                                        <div className="flex items-center space-x-3">
                                          {product.productId?.NormalPrice && (
                                            <span className="text-xs text-gray-400 line-through">
                                              Rp{" "}
                                              {product.productId.NormalPrice.toLocaleString()}
                                            </span>
                                          )}
                                          {product.productId?.Stock !==
                                            undefined && (
                                            <span
                                              className={`text-xs px-2 py-0.5 rounded ${product.productId.Stock > 0 ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                                            >
    ...
    return (
      <div className="space-y-6">
                ...
                <div key={cat.category} className="flex items-center">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm text-gray-500">
                        {cat.eligible} eligible · {cat.used} used (
                        {cat.usagePercentage}%)
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${Math.min(cat.usagePercentage, 100)}%`,
                        }}
                      ></div>
                    </div>
                  </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-4 gap-4">
            {Object.entries(analytics.eligibilityCounts || {}).map(
              ([cat, count]) => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-gray-800 flex items-center">
              ...
              <strong>75.</strong> Discount Page Info
            </h1>
      ...
      {infoModalCategory &&
        categoryDisplayNames[infoModalCategory]?.eligibility && (
          <div
          ...
          >
            ...
            >
              {/* Modal Header */}
              <div
                className={`${categoryDisplayNames[infoModalCategory]?.color} p-6 text-white`}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <span className="text-4xl">
                      {categoryDisplayNames[infoModalCategory]?.icon}
                    </span>
                    <div>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {categoryDisplayNames[
                      infoModalCategory
                    ]?.eligibility.howToQualify.map((item, idx) => (
      ...
      {showModeToggle && (
        <ModeToggle
          componentName="Discount Page Info"
