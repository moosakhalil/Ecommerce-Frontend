...
const ReferralVideoManagement159A = () => {
  ...
  const API_BASE = `${API_BASE_URL}/api/videos/referral`;
  ...
  const loadVideoData = async (videoId) => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_BASE_URL}/api/videos/data/${videoId}`,
      );
                          ...
                          >
                            <div className="text-center">
                              {loadingVideoId === video._id ? (
                                ...
                                <>
                                  <PlayCircle className="h-16 w-16 mx-auto mb-3 text-blue-500 hover:text-blue-600 transition-colors" />
                                  <span className="text-lg text-slate-600">
                                    Click to play
                                  </span>
