...
export default function PayCommission() {
  ...
  const payCommission = async (customerId, customerName, availableAmount) => {
    const amount = prompt(
      `Enter commission amount to pay (Available: Rs. ${availableAmount.toFixed(2)}):`,
    );
      ...
      >
        ...
        >
          ...
          <span style={{ color: "#065f46", fontSize: "14px" }}>
            Only <strong>commission eligible foremen</strong> with available
            balance are shown. Click on a foreman to view their payment history.
          </span>
        </div>
                          ...
                          <div style={{ padding: "16px 24px" }}>
                            ...
                            {paymentHistories[customer._id]?.length > 0 ? (
                              ...
                              >
                                ...
                                <tbody>
                                  {paymentHistories[customer._id].map(
                                    (payment, idx) => (
                                      <tr
                                        key={idx}
                                        style={{
                                      ...
                                      >
                                        ...
                                        >
                                          {payment.staffSignature?.staffName ||
                                            payment.paidBy ||
                                            "Admin"}
                                        </td>
                                        <td
