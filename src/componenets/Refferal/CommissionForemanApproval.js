      ...
      >
        ...
        >
          ...
          <span style={{ color: "#92400e", fontSize: "14px" }}>
            Only <strong>approved foremen</strong> are shown here. To approve a
            foreman, go to page 153.
          </span>
        </div>
                  ...
                  >
                    ...
                    <td style={{ padding: "14px 16px", textAlign: "center" }}>
                      {!customer.isCommissionEligible ? (
                        <button
                          onClick={() =>
                            updateCommissionEligibility(customer._id, true)
                          }
                          disabled={updating}
                          style={{
                            padding: "8px 16px",
                        ...
                        <button
                          onClick={() =>
                            updateCommissionEligibility(customer._id, false)
                          }
                          disabled={updating}
                          style={{
                            padding: "8px 16px",
