      ...
      <div className="flex-1 ml-64 p-12">
        <div className="min-h-screen bg-gray-100">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="flex items-center justify-between relative">
                <div>
                  <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                    <Video /> <strong>10.</strong> Video Management System
                  </h1>
            ...
            {showModeToggle && (
              <ModeToggle
                componentName="Video Management System"
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  {videos.some((v) => v.assignedComponents.length > 0) ? (
                    <div className="space-y-6">
                      {Object.entries(groupedComponents).map(
                        ([category, components]) => {
                          const componentsWithVideos = components.filter(
                            (comp) =>
                              videos.some((video) =>
                            ...
                            <div key={category}>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {componentsWithVideos.map((component) => {
                                  const assignedVideos = videos.filter(
                                    (video) =>
                                      video.assignedComponents.includes(
                                        component.id,
                                      ),
                                  );
