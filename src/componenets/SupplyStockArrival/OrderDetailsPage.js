...
const OrderDetailsPage = () => {
  ...
  const issueCategoryGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          key: "packagingOpenedTampered",
          label: "Packaging opened or tampered",
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          key: "incorrectProductDescription",
          label: "Incorrect product description",
        },
        {
          key: "missingInstructionsManual",
          label: "Missing instructions or manual",
        },
        {
          key: "missingWarrantyDocuments",
          label: "Missing warranty documents",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        {
          key: "notMeetingSafetyStandards",
          label: "Not meeting safety standards",
        },
        { key: "missingSafetyWarnings", label: "Missing safety warnings" },
        {
          key: "incorrectCertification",
          label: "Incorrect certification marks",
        },
      ],
    },
  ];
      ...
      <div style={styles.pageContainer}>
        ...
        <div style={styles.mainContent}>
          <button
            ...
            onClick={() => navigate("/supply-stock-arrival")}
          >
            ← Back to Orders
          </button>
          <div
            style={{ textAlign: "center", padding: "60px", color: "#dc3545" }}
          >
  ...
  const progress = order.verificationProgress || {
    verified: 0,
    total: 0,
    percentage: 0,
  };
              ...
              <div key={index} style={styles.productCard}>
                ...
                <div style={styles.productInfo}>
                  ...
                  <div style={{ color: "#6c757d", fontSize: "13px" }}>
                    ...
                    {product.productItemNumber || index + 1} • ID:{" "}
                    {product.productId}
                  </div>
                  <div style={{ fontSize: "14px" }}>
                    Quantity: <strong>{product.receivedQuantity || 0}</strong> /{" "}
                    {product.orderedQuantity}
                    {" • "}
                    Price:{" "}
                    <strong>Rp {(product.price || 0).toLocaleString()}</strong>
                  </div>
                  {product.details && (
