...
const SupplierOrderList = () => {
  ...
  const getStatusBadge = (status) => {
    ...
    return (
      statusStyles[status] || { bg: "#E2E3E5", color: "#383D41", label: status }
    );
  };
  ...
  return (
    <div style={styles.pageContainer}>
          ...
          >
            <div>
              <h1 style={styles.title}>
                <strong>38.</strong> 📦 Supply/Stock Arrival from Supplier
              </h1>
                ...
                {orders.map((order) => {
                  ...
                  return (
                    <tr
                      ...
                      style={styles.tr}
                      onClick={() =>
                        navigate(`/supply-stock-arrival/${order._id}`)
                      }
                      onMouseEnter={(e) =>
                      ...
                      <td style={{ ...styles.td, fontWeight: "600" }}>
                        ...
                        {order.products && order.products.length > 0 && (
                          ...
                          >
                            /(
                            {order.products
                              .map((p, i) => p.productItemNumber || i + 1)
                              .join(",")}
                            )
                          </span>
                        )}
      ...
      {showModeToggle && (
        <ModeToggle
          componentName="Supply Stock Arrival"
