...
const EmployeePermission = () => {
  ...
  const allComponents = [
    ...
    {
      section: "HISTORY",
      items: [{ id: 90, name: "History orders supplier (Admin office)" }],
    },
    {
      section: "FINANCE",
      items: [
    ...
    {
      section: "FOREMAN",
      items: [{ id: 160, name: "from human earning structure" }],
    },
    {
      section: "SETTINGS",
      items: [
  ...
  const handleEmployeeSelect = (employee) => {
    ...
    allComponents.forEach((section) => {
      section.items.forEach((component) => {
        ...
        employeePermissions[component.id] =
          employee.permissions?.includes(component.id) || false;

        // Check sub-items if they exist
        if (component.subItems) {
          component.subItems.forEach((subItem) => {
            employeePermissions[subItem.id] =
              employee.permissions?.includes(subItem.id) || false;
          });
        }
      });
    });
  ...
  return (
    <div className="flex h-screen bg-gray-100">
        ...
        <div className="bg-white shadow-sm p-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold text-gray-800">
              <strong>109.</strong> Employee Permission Management
            </h1>
          ...
          {selectedEmployee ? (
                ...
                {activeTab === "info" ? (
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        {selectedEmployee.profilePicture ? (
                          <button
                            onClick={() =>
                              openImageModal(
                                `${API_BASE_URL}/${selectedEmployee.profilePicture}`,
                              )
                            }
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-6 bg-blue-50 p-4 rounded-lg border-l-4 border-blue-500">
                      <strong>Instructions:</strong> Check the boxes below to
                      grant this employee access to specific pages and
                              ...
                              component.subItems.length > 0 ? (
                                ...
                                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded hover:bg-gray-100 transition-colors ml-2">
                                  <input
                                    ...
                                    onChange={() =>
                                      handlePermissionChange(component.id)
                                    }
                                    ...
                                    {component.subItems.map((subItem) => (
                                      ...
                                      >
                                        <input
                                          ...
                                          checked={
                                            permissions[subItem.id] || false
                                          }
                                          onChange={() =>
                                            handlePermissionChange(subItem.id)
                                          }
            ...
            <div className="bg-white rounded-lg shadow p-12 text-center">
              ...
              <p className="text-gray-500">
                Please select an employee from the grid above to view their
                information and manage permissions
              </p>
            </div>
          )}
        </div>
      ...
      {showModeToggle && (
        <ModeToggle
          componentName="Employee Permission Management"
