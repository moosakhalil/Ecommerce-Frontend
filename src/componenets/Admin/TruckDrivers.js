...
const TruckDrivers = () => {
  ...
  const fetchVehicles = async () => {
    try {
      ...
      const allVehiclesData =
        response.data.data || response.data.vehicles || [];
  ...
  const fetchDrivers = async () => {
    try {
      ...
      const driverEmployees = response.data.employees.filter(
        (emp) =>
          emp.roles?.includes("driver") ||
          emp.roles?.includes("driver-on-delivery"),
      );
  ...
  return (
    <div className="flex h-screen bg-gray-50">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-3xl font-bold text-gray-800">
                <strong>102.</strong> Assign Driver to Vehicles
              </h1>
              <button
              ...
              {loading ? (
                ...
                <div className="p-8 text-center text-gray-500">
                  {vehicleSearch
                    ...
                    : `No ${selectedVehicleType} vehicles found`}
                </div>
              ) : (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {drivers
                    ...
                    .map((driver) => {
                      ...
                      console.log(
                        `Driver ${driver.name} assigned vehicles:`,
                        assignedVehicles,
                      );
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
                  ...
                  <p className="text-blue-800 text-sm leading-relaxed">
                    This page allows you to assign specific drivers to vehicles.
                    Select a vehicle to see its current assignment status and
                    choose a driver to allocate to it.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-gray-600 space-y-2 pl-4 list-disc">
                    <li>
                      Select <strong>Vehicle Type</strong> (Scooter/Truck) to
                      filter the list.
                    </li>
                    <li>Search for a specific vehicle by number plate.</li>
                    <li>
                      Click <strong>Assign Driver</strong> or{" "}
                      <strong>Change Driver</strong> on a vehicle row.
                    </li>
                    <li>
                      Select a driver from the dropdown in the popup modal.
                    </li>
                    <li>
                      Confirm assignment to link the driver to the vehicle.
                    </li>
                  </ul>
                </div>
              </div>
      ...
      {showModeToggle && (
        <ModeToggle
          componentName="Assign Driver to Vehicles"
