...
import ChatbotFlowChart from "./componenets/Settings/ChatbotFlowChart";
import ChatbotMessageEditor from "./componenets/Settings/ChatbotMessageEditor";
  ...
  return (
    <Router>
      <Routes>
        ...
        />
        <Route path="/delivery/packing-staff" element={<PackingStaffPage />} />
        <Route
        ...
        />
        <Route path="/delivery/driver" element={<DriverPage />} />
        <Route
        ...
        <Route
          path="/settings/chatbot-message-editor"
          element={<ChatbotMessageEditor />}
        />
        <Route
          path="/settings/chatbot-messages"
          element={<ChatbotMessagesViewer />}
        />
        <Route
          path="/settings/chatbot-flow-chart"
          element={<ChatbotFlowChart />}
        />
